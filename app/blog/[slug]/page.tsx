import PostDetailComponent from '../../../src/shared/domains/posts/components/post-detail-component';
import { PostDetail } from '../../../src/shared/domains/posts/models/post-detail';
import { Text } from 'thon-ui';
import { Post } from '../../../src/shared/domains/posts/models/post';
...
async function getPost(slug: string) {
  const postResponse = await fetch(
    `${process.env.BLOG_PROVIDER_BASE_API}/contents/NiltJs/${slug}`,
    { next: { revalidate: 30 } }
  );
